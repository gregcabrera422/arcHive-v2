...
public class AnnouncementActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    String[] SCOPES = {ClassroomScopes.CLASSROOM_COURSES_READONLY, ClassroomScopes.CLASSROOM_ANNOUNCEMENTS_READONLY,
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            Toast.makeText(AnnouncementActivity.this, "No network connection available.", Toast.LENGTH_LONG);
        } else {
        ...
        switch(requestCode) {
            case REQUEST_GOOGLE_PLAY_SERVICES:
                if (resultCode != RESULT_OK) {
                    Toast.makeText(AnnouncementActivity.this, "This app requires Google Play Services. " +
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            courseAnnouncements = new ArrayList<>();
            ...
            if (announcements != null) {
                for (Announcement announcement : announcements) {
                    ...
                    String newDate =
                            announcement.getCreationTime().substring(0,announcement.getCreationTime().lastIndexOf("T"));

                        courseAnnouncements.add(new CourseAnnouncement(announcement.getText(), newDate, courseTeacher, photoURL));
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                tvEmpty.setText("No Announcements");
            } else {
                adapter = new AnnouncementRecyclerAdapter(courseAnnouncements, AnnouncementActivity.this);
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            AnnouncementActivity.REQUEST_AUTHORIZATION);
                } else {
                    Toast.makeText(AnnouncementActivity.this, "The following error occurred: "+ mLastError.getMessage(), Toast.LENGTH_LONG);
                }
            } else {
                Toast.makeText(AnnouncementActivity.this, "Request cancelled.", Toast.LENGTH_LONG);
            }
        }
    }
